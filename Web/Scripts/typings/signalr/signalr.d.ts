...
interface SignalR {
    ...
    */
    ...
    connectionState: any;//SignalR.ConnectionStates;
    events: SignalR.AvailableEvents;
    transports: any;//SignalR.Transports;
    hub: HubConnection;//SignalR.Hub.Connection;
    hubConnection: (url?: string) => SignalR;//SignalR.Hub.HubCreator;
...
interface JQueryStatic {
    signalR: SignalR;
    connection: SignalR;
	hubConnection: (url?: string, options?: HubConnectionSettings) => HubConnection;//SignalR.Hub.HubCreator;
}
